...
class SQLiteLSMConjunctiveGraphTestCase(unittest.TestCase):

    tmpdir = tempfile.gettempdir()
    path = os.path.join(tmpdir, "test_sqlitelsm")

    def setUp(self):
        self.store_name = "SQLiteLSM"
    ...
    def tearDown(self):
        self.g.close()
        self.g.store.destroy(configuration=self.path)
    ...
    def test_open_shut(self):
        ...
        # reopen the graph
        self.g = ConjunctiveGraph("SQLiteLSM")
